...
Indexes a Python codebase at startup and exposes smart tools via MCP
so an AI can ask deep questions about the code.

Usage:
  python main.py --root /path/to/your/project
